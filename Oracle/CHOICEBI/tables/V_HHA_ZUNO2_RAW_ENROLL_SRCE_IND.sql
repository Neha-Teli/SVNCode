DROP VIEW V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND;

CREATE OR REPLACE VIEW V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND
(
    MEMBER_ID,
    SUBSCRIBER_ID,
    DL_LOB_ID,
...
GRANT SELECT ON V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND TO CHOICEBI_RO;

GRANT SELECT ON V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND TO CHOICEBI_RO_NEW;

GRANT SELECT ON V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND TO LINKADM2;

GRANT SELECT ON V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND TO ROC_RO;

GRANT SELECT ON V_HHA_ZUNO2_RAW_ENROLL_SRCE_IND TO ROC_RO2;
