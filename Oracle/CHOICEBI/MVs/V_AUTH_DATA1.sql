...
WHERE  1 = 1 AND c.deleted_by IS NULL AND c.deleted_on IS NULL AND code.deleted_on IS NULL AND code.deleted_by IS NULL AND d.deleted_on IS NULL AND d.deleted_by IS NULL AND p.deleted_by IS NULL AND
       UPPER
       (SUBSTR                                                                                                                                                                                        ( p.UNIQUE_ID, 1, 1)
       ) = 'V';
