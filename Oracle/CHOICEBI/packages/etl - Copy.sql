        ...
        */
        ...
        (
                ...
                from
                    ...
                    CHOICEBI.V_FACT_MEMBER_MONTH_EXP a
                where
                    line_of_business = v_lob_name and
                    to_date(a.month_id, 'yyyymm') between to_date(v_jan1_dt, 'yyyymmdd') and to_date(v_dec31_dt, 'yyyymmdd')
        )
        select *
        from
                    ...
                    (
                        ...
                        SELECT /*+ noparallel  leading(b, t1)*/
                          ...
                          where 
                              ...
                              AND t1.PAY_CO_CODE IN ('00110','00107')
                              AND t1.pay_id_no like 'V%'
                    ) a, (SELECT * FROM CHOICEBI.V_FACT_MEMBER_MONTH_EXP b WHERE line_of_business = v_lob_name) B
                where
        ...
        select /*+ NOREWRITE*/
         ...
         (
                ...
                from
                    ...
                    (SELECT * FROM CHOICEBI.V_FACT_MEMBER_MONTH_EXP b WHERE line_of_business = v_lob_name) B
                where
                    a.member_id = b.member_id(+) and
                    to_char(a.service_Date,'yyyymm') = b.month_id(+)
        ) A;
