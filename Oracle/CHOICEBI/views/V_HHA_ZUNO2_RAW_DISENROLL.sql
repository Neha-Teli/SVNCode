DROP VIEW V_HHA_ZUNO2_RAW_DISENROLL;

CREATE OR REPLACE VIEW V_HHA_ZUNO2_RAW_DISENROLL
(
    MEMBER_ID,
    SUBSCRIBER_ID,
    DL_LOB_ID,
    ...
    SELECT /*+ use_hash(A B C M)) MATERIALIZE*/
          A.MEMBER_ID,
           ...
           --MONTHS_BETWEEN(TO_DATE(A.MONTH_ID, 'yyyymm'), TO_DATE(TO_CHAR(A.DISENROLLMENT_DATE, 'YYYYMM'), 'YYYYMM') ) + 3 AS MONTHS_DISENROLLED,
           A.REGION_NAME,
           CASE
...
GRANT SELECT ON V_HHA_ZUNO2_RAW_DISENROLL TO MICHAEL_K;

GRANT SELECT ON V_HHA_ZUNO2_RAW_DISENROLL TO MSTRSTG;

GRANT SELECT ON V_HHA_ZUNO2_RAW_DISENROLL TO MSTRSTG2;

GRANT SELECT ON V_HHA_ZUNO2_RAW_DISENROLL TO ROC_RO;

GRANT SELECT ON V_HHA_ZUNO2_RAW_DISENROLL TO ROC_RO2;
