DROP VIEW V_MEMBER_RISK;

CREATE OR REPLACE VIEW V_MEMBER_RISK_NEXT_PERIOD
(
    MEDICAID_NUM,
    SUBSCRIBER_ID,
    NUM_SCIC_PAST_YR,
...
GRANT SELECT ON V_MEMBER_RISK_NEXT_PERIOD TO PICBI WITH GRANT OPTION;
